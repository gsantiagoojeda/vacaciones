...
class SEOActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_seoactivity)
    ...
    private fun initListeners() {
        ...
        BtnSv.setOnClickListener {
            createSV(paramSV(user, dateStart, dateStart), this).toString()
            ...
            if (call.isSuccessful) {
                ...
                if (!err) {
                    runOnUiThread {
                        ...
                        Log.i("gonzalito", "solicitud creada")
